...
- Before comparing actions, weighting evidence, asserting a boundary, or reusing a conclusion after a premise changed, record the decision trace and run `python3 fable-enforce/scripts/kernel_check.py TRACE.json`. K-1..K-5 violations invalidate the trace.
